      ...
      <div className="flex flex-col md:flex-row gap-8 w-full max-w-5xl bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="flex flex-col gap-4 justify-center md:w-1/2">
          ...
          <div className="flex gap-4 mt-6">
            <button className="bg-[#23be0a] hover:bg-green-700 text-white py-2 px-4 rounded-lg">Read</button>
            <button className="bg-[#b2dffc] hover:bg-blue-500 text-white py-2 px-4 rounded-lg">Wishlist</button>
          </div>
        </div>
      </div>
    </div>
